    ...
    useEffect(() => {
        ...
        const checkAuthAndFetchData = async (): Promise<void> => {
            try {
                ...
                await AsyncStorage.setItem(
                    "studentDashboardCurriculum",
                    JSON.stringify(allCurriculum)
                );
                                    ...
                                    <View style={styles.marksSummary}>
                                        <View style={styles.marksChart}>
                                            <Text style={styles.marksAverage}>
                                                {calculateAverageScore(selectedCourse._id)}%
                                            </Text>
                    ...
                    <View key={assignment._id} style={styles.assignmentItem}>
                        <View style={styles.assignmentHeader}>
                            <View
                                style={[
                                    styles.courseTag,
                                    { backgroundColor: assignment.color || "#5c51f3" },
                                ]}
                            >
                            ...
                            <View style={styles.courseCardStats}>
                                <View style={styles.courseCardStat}>
                                    ...
                                    <Text style={styles.courseCardStatText}>
                                        {calculateAttendancePercentage(item._id)}% Attendance
                                    </Text>
                                </View>
                                <View style={styles.courseCardStat}>
                                    <MaterialIcons name="grade" size={16} color="#5c51f3" />
                                    <Text style={styles.courseCardStatText}>
                                        {calculateAverageScore(item._id)}% Average
                                    </Text>
                                </View>
                            </View>
                        ...
                        <View style={styles.assignmentCardHeader}>
                            <View
                                style={[
                                    ...
                                    { backgroundColor: item.color || "#5c51f3" },
                                ]}
                            >
